  ...
  return (
    <PageShell>
      <Helmet>
        ...
        <meta name="description" content="Long before your interview begins, our preparation already has." />
      </Helmet>
      <Hero />
      <StorySection />
  ...
  return (
    <section className="grid w-full items-center gap-8 lg:grid-cols-[4fr_6fr] lg:gap-10 bg-[#0A102A]">
      ...
      <div className="px-5 py-8 sm:px-6 sm:py-10 lg:py-14 lg:pl-10 flex flex-col justify-center">
        ...
        <h1 className="text-[36px] font-extrabold leading-[1.08] tracking-tight text-white sm:text-[48px] lg:text-[24px] xl:text-[30px] 2xl:text-[40px] min-[1920px]:text-[52px]">
          Long before<br />
          your interview begins,<br />
        ...
        <p className="mt-6 text-[15px] leading-relaxed text-gray-300 max-w-[500px]">
          Every recommendation from HireLeap is backed by Career Intelligence—a combination of advanced AI, real-time market insights, experienced professionals, and disciplined execution—working together long before you ever hit "Apply".
        </p>
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-3 sm:gap-4 w-full">
          ...
          >
            Start Your Career Journey <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" />
          </Link>
          <VideoModal>
            <button 
              className="group inline-flex h-12 items-center justify-center gap-2.5 rounded-lg border border-white/20 bg-transparent px-6 text-[14px] sm:text-[15px] font-semibold text-white transition-all hover:bg-white/5 hover:border-white/40 w-full sm:w-auto whitespace-nowrap"
            >
        ...
        <div className="mt-8 flex flex-col sm:flex-row justify-start items-start gap-8 sm:gap-6 lg:gap-8 border-t border-gray-800 pt-8 w-full">
          <div className="flex items-start gap-3 max-w-[200px]">
            ...
            <div className="flex flex-col gap-1">
              ...
              <span className="text-gray-400 text-[11px] leading-relaxed font-medium">Data, insights, and expertise behind every decision.</span>
            </div>
          </div>
          <div className="flex items-start gap-3 max-w-[200px]">
            ...
            <div className="flex flex-col gap-1">
              ...
              <span className="text-gray-400 text-[11px] leading-relaxed font-medium">Advanced technology powered by experienced professionals.</span>
            </div>
          </div>
          <div className="flex items-start gap-3 max-w-[200px]">
            ...
            <div className="flex flex-col gap-1">
              ...
              <span className="text-gray-400 text-[11px] leading-relaxed font-medium">Every action is aligned with your goals and long-term success.</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.1fr_1fr] gap-12 lg:gap-8 xl:gap-12 items-start">
          ...
          <div className="flex flex-col">
            <div className="mb-4 lg:mb-6">
              <p className="text-[#3b2dd0] font-semibold text-[17px] mb-2 font-serif tracking-tight">Real stories. Real impact.</p>
              <h2 className="text-gray-900 font-serif text-[36px] lg:text-[40px] leading-[1.1] tracking-tight">
                <span className="whitespace-nowrap">Preparation changes</span><br className="hidden sm:block" /> everything.
              </h2>
            </div>
            ...
            <div className="flex flex-col lg:block relative gap-0">
              ...
              <div className="lg:absolute lg:top-14 lg:left-8 bg-white rounded-2xl p-6 lg:p-7 shadow-[0_12px_40px_rgb(0,0,0,0.12)] border border-gray-100 lg:min-w-[240px] lg:max-w-[280px] z-10 relative -mt-16 sm:-mt-24 mx-4 sm:mx-auto sm:max-w-[320px] lg:mx-0 lg:mt-0 order-2 lg:order-none">
                <div className="flex flex-col gap-1 mb-6">
                  <span className="font-bold text-[#0f172a] text-[18px] tracking-tight">Meet Arjun</span>
          ...
          <div className="flex flex-col lg:pt-[90px]">
            <p className="text-gray-600 text-[15px] leading-relaxed mb-5">
              Arjun had 8 years of experience. Every evening after work, he spent three hours applying for jobs. After four months, he had 147 applications, 2 interviews, and zero offers. He started believing the market had no opportunities left.
            </p>
            
            <h3 className="text-[#3b2dd0] text-[22px] font-medium font-serif leading-snug mb-5">
              The market wasn't his problem.<br/>
              Preparation was.
            </h3>
            
            <p className="text-gray-900 font-bold text-[15px] mb-3">Here's what we did for Arjun:</p>
            ...
            <ul className="space-y-3 mb-6">
              {[
                ...
                <li key={i} className="flex items-center gap-3">
                  ...
                  <span className="text-gray-700 text-[14px] whitespace-nowrap lg:whitespace-normal">{item}</span>
                </li>
              ))}
            </ul>
            ...
            <div className="bg-[#f0f0fe] rounded-xl p-5 border border-[#e0e0fd]">
              <p className="text-[#3b2dd0] font-medium leading-relaxed text-[15px]">
                Eight weeks later, Arjun wasn't applying more. He was getting interviews—and receiving offers.
              </p>
            </div>
          </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 flex flex-col h-full">
              ...
              <div className="mt-auto border-t border-gray-100 pt-8 grid grid-cols-3 gap-2">
                <div className="flex flex-col items-center text-center">
                  ...
                  <div className="text-[11px] font-medium text-gray-500 uppercase tracking-wide">Offers</div>
                </div>
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <div className="text-[11px] font-medium text-gray-500 uppercase tracking-wide leading-tight px-1">Higher Salary</div>
                </div>
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <div className="font-bold text-gray-900 text-[19px] leading-none mb-1">8 Weeks</div>
                  <div className="text-[11px] font-medium text-gray-500 uppercase tracking-wide leading-tight px-1">From Start to Offers</div>
                </div>
              </div>
            </div>
          </div>
          ...
          {steps.map((step, index) => (
            <div key={index} className="flex flex-col relative text-center items-center">
              ...
              <div className="flex flex-col text-center px-2">
                <h4 className="text-[14px] xl:text-[15.5px] font-bold text-[#0A102A] mb-3 leading-tight lg:min-h-[46px]">{step.title}</h4>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-12 lg:gap-8 items-center">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-[14px] sm:text-[15px] text-gray-400 leading-relaxed max-w-[440px]">
              Our intelligence engine combines the power of AI, live market data, industry expertise, and structured execution to deliver recommendations that are more accurate, more relevant, and more impactful.
            </p>
          </div>
            ...
            <div className="relative w-[700px] min-w-[700px] shrink-0 h-[500px] transform scale-[0.45] sm:scale-[0.6] md:scale-100 transform-origin-center -my-[130px] sm:-my-[100px] md:my-0">
                ...
                <div className="mb-3 relative">
                  ...
                  <div className="flex items-center justify-center w-14 h-14">
                    <svg width="48" height="48" viewBox="0 0 40 40" fill="none" className="text-white">
                      ...
                      <path d="M 13.5 24 L 26.5 14" stroke="currentColor" strokeWidth="4.5" strokeLinecap="round" />
                      <circle cx="20" cy="11" r="3.5" fill="currentColor" />
                    </svg>
                  </div>
                </div>
                <span className="text-white font-medium text-[20px] leading-tight text-center tracking-tight">Career<br/>Intelligence</span>
              </div>
              ...
              <div className="absolute top-[70px] left-[0px] flex gap-4 w-[240px]">
                ...
                <div className="flex flex-col pt-1">
                  <span className="text-white font-semibold text-[13.5px] mb-1 leading-tight">Advanced AI</span>
                  <span className="text-gray-400 text-[11px] leading-[1.4]">Analyzing millions of data points in real time</span>
                </div>
              </div>
              ...
              <div className="absolute bottom-[70px] left-[0px] flex gap-4 w-[240px]">
                ...
                <div className="flex flex-col pt-1">
                  <span className="text-white font-semibold text-[13.5px] mb-1 leading-tight">Industry Expertise</span>
                  <span className="text-gray-400 text-[11px] leading-[1.4]">20+ years of experience across multiple domains</span>
                </div>
              </div>
              ...
              <div className="absolute top-[70px] right-[0px] flex gap-4 w-[240px]">
                ...
                <div className="flex flex-col pt-1">
                  <span className="text-white font-semibold text-[13.5px] mb-1 leading-tight">Live Market Intelligence</span>
                  <span className="text-gray-400 text-[11px] leading-[1.4]">Real-time data on roles, companies, locations, and opportunities</span>
                </div>
              </div>
              ...
              <div className="absolute bottom-[70px] right-[0px] flex gap-4 w-[240px]">
                ...
                <div className="flex flex-col pt-1">
                  <span className="text-white font-semibold text-[13.5px] mb-1 leading-tight">Structured Execution</span>
                  <span className="text-gray-400 text-[11px] leading-[1.4]">Disciplined processes that turn intelligence into results</span>
                </div>
              </div>
              ...
              <svg className="absolute inset-0 w-full h-full pointer-events-none" style={{ zIndex: 0 }}>
                <defs>
                  ...
                  <marker id="arrow-down" markerWidth="5" markerHeight="5" refX="4" refY="2.5" orient="auto-start-reverse">
                    <path d="M 0 0 L 5 2.5 L 0 5 z" fill="#9ca3af" />
                  </marker>
                </defs>
                
                {/* TL -> Center */}
                <path d="M 245 94 L 265 94 L 295 150" fill="none" stroke="#e2e8f0" strokeWidth="1" markerEnd="url(#arrow)" />
                
                {/* TR -> Center */}
                <path d="M 455 94 L 435 94 L 405 150" fill="none" stroke="#e2e8f0" strokeWidth="1" markerEnd="url(#arrow)" />
                
                {/* BL -> Center */}
                <path d="M 245 406 L 265 406 L 295 350" fill="none" stroke="#e2e8f0" strokeWidth="1" markerEnd="url(#arrow)" />
                
                {/* BR -> Center */}
                <path d="M 455 406 L 435 406 L 405 350" fill="none" stroke="#e2e8f0" strokeWidth="1" markerEnd="url(#arrow)" />
                
                {/* Center -> Bottom Pill */}
                <path d="M 350 370 L 350 425" fill="none" stroke="#9ca3af" strokeWidth="1" markerEnd="url(#arrow-down)" />
              </svg>
              ...
              <div className="absolute -bottom-[20px] left-1/2 -translate-x-1/2 border border-[#475569]/60 bg-[#0f172a]/80 backdrop-blur-sm rounded px-6 py-2 w-max max-w-[95%] text-center">
                <span className="text-gray-300 font-serif italic text-[14.5px]">One Better Recommendation. Every Time.</span>
              </div>
  ...
  const cards = [
    {
      ...
      image: "https://images.unsplash.com/photo-1501250987900-211872d97eaa?auto=format&fit=crop&w=600&q=80",
      icon: MapPin,
    },
    {
    ...
    <section className="w-full bg-[#f8f9fc] pt-6 pb-16 lg:pt-8 lg:pb-24">
      <div className="max-w-[1536px] mx-auto px-5 sm:px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5 lg:gap-6">
          {cards.map((card, idx) => (
            <div key={idx} className="flex flex-col bg-white rounded-xl overflow-hidden border border-gray-100 shadow-[0_4px_20px_rgb(0,0,0,0.03)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.06)] transition-shadow">
              ...
              <div className="flex flex-col p-5 xl:p-6 flex-grow">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h4 className="text-[13.5px] xl:text-[14px] font-bold text-[#0f172a] leading-tight">{card.title}</h4>
                </div>
      ...
      <div className="w-full lg:w-7/12 flex flex-col justify-center px-6 sm:px-8 lg:px-12 py-8 lg:py-6 border-l border-white/5">
        <div className="max-w-[600px]">
          <div className="flex items-start gap-3 mb-2">
            <span className="font-serif text-[42px] lg:text-[48px] text-white leading-none mt-1 lg:mt-0">“</span>
          ...
          <div className="pl-[45px] lg:pl-[52px]">
            <p className="text-gray-200 text-[13px] mb-4">
              That's the HireLeap difference.
            </p>
