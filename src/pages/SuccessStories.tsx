...
import { ArrowRight, Sun, Compass, BookOpen, DoorOpen, Award, TrendingUp, XCircle, Check, CheckCircle2 } from "lucide-react";
  ...
  return (
    <PageShell>
      <Helmet>
        ...
        <meta name="description" content="Every remarkable career transformation begins with a moment that almost nobody sees." />
      </Helmet>
      <Hero />
      <ChaptersSection />
      <PathSection />
  ...
  return (
    <section className="grid w-full items-center gap-0 lg:grid-cols-[45fr_55fr] bg-[#0A102A] text-white">
      ...
      <div className="px-5 py-12 sm:px-6 sm:py-16 lg:py-20 lg:pl-10 xl:pl-20 flex flex-col justify-center h-full">
        ...
        <h1 className="text-[36px] font-normal leading-[1.15] tracking-tight text-white sm:text-[44px] lg:text-[40px] xl:text-[48px] font-serif mb-6">
          Every remarkable<br />
          career transformation<br />
          begins with a moment<br />
        ...
        <div>
          <Link to="/career-journeys" className="inline-flex items-center justify-center space-x-2 rounded-[6px] bg-[#3b2dd0] px-7 py-3 font-bold text-white transition-transform hover:scale-105 hover:bg-[#2f22a8] shadow-lg">
  ...
  const chapters = [
    {
      ...
      illustration: "https://raw.githubusercontent.com/balazser/undraw-svg-collection/refs/heads/main/svgs/graduation.svg",
      bgColor: "bg-[#f3f4f6]"
    },
    {
      number: "02",
      title: <>You've built<br />experience.</>,
      description: "Yet the interviews have quietly stopped coming.",
      illustration: "https://raw.githubusercontent.com/balazser/undraw-svg-collection/refs/heads/main/svgs/working-late.svg",
      bgColor: "bg-[#faf5ff]"
    },
    {
      number: "03",
      title: <>You want to<br />change careers.</>,
      description: "You're excited. You're also terrified.",
      illustration: "https://raw.githubusercontent.com/balazser/undraw-svg-collection/refs/heads/main/svgs/road-sign.svg",
      bgColor: "bg-[#fffbeb]"
    },
    {
      number: "04",
      title: <>You've taken a<br />career break.</>,
      description: "Now you're wondering if the industry has moved on.",
      illustration: "https://raw.githubusercontent.com/balazser/undraw-svg-collection/refs/heads/main/svgs/through-the-window.svg",
      bgColor: "bg-[#f0fdf4]"
    },
    {
      number: "05",
      ...
      illustration: "https://raw.githubusercontent.com/balazser/undraw-svg-collection/refs/heads/main/svgs/unboxing.svg",
      bgColor: "bg-[#fdf2f8]"
    },
    {
      number: "06",
      title: <>You've become<br />a leader.</>,
      description: "Now you're responsible for helping others grow.",
      illustration: "https://raw.githubusercontent.com/balazser/undraw-svg-collection/refs/heads/main/svgs/goal.svg",
      bgColor: "bg-[#eff6ff]"
    }
  ];
    ...
    <section className="w-full bg-white border-t border-gray-100 px-5 sm:px-6 lg:px-10 xl:px-20 pt-16 sm:pt-20 pb-4 sm:pb-6 flex flex-col items-start">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 w-full">
        {chapters.map((chapter) => (
          <div key={chapter.number} className="bg-white border border-gray-100 rounded-[12px] p-5 flex flex-col items-start shadow-sm hover:shadow-md transition-shadow h-full">
            <div className={`w-full h-36 flex items-center justify-center mb-6 overflow-hidden ${chapter.bgColor} rounded-lg`}>
              <img 
            ...
            <div className="text-[14px] font-sans font-medium text-[#7161fa] mb-2">{chapter.number}</div>
            <h3 className="text-[#0A102A] text-[17px] font-serif font-bold leading-snug mb-3">{chapter.title}</h3>
            <p className="text-[#52525b] text-[13px] font-sans font-normal leading-relaxed">{chapter.description}</p>
          </div>
        ))}
      </div>
    </section>
    ...
    <section className="w-full bg-[#fbfbfb] border-t border-gray-100 px-5 sm:px-6 lg:px-10 xl:px-20 pt-6 sm:pt-8 pb-6 sm:pb-8 flex flex-col items-start relative overflow-hidden">
          ...
          {steps.map((step, idx) => {
            ...
            return (
              <div key={idx} className="flex flex-col items-center text-center px-2">
                ...
                {/* Text content */}
                <h3 className="text-[#0A102A] text-[15px] font-sans font-bold mb-2">{step.title}</h3>
      ...
      <div className="mt-10 w-full text-center max-w-[800px] mx-auto">
        <p className="font-serif text-[18px] sm:text-[22px] text-[#0A102A] leading-relaxed">
          Every career transformation is unique.<br />
      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-0 relative">
        ...
        <div className="relative rounded-[16px] lg:rounded-r-none overflow-hidden min-h-[300px] flex items-center bg-[#f3f4f6] text-[#0A102A] border-r border-gray-100 lg:border-r-0">
          ...
          <div className="relative z-10 p-6 sm:p-8 w-full max-w-[340px] flex flex-col items-start">
            <span className="text-[11px] font-bold uppercase tracking-[0.2em] text-[#475569] mb-4">BEFORE</span>
        ...
        <div className="relative rounded-[16px] lg:rounded-l-none overflow-hidden min-h-[300px] flex items-center bg-[#faf8ff] text-[#0A102A]">
          ...
          {/* Content */}
          <div className="relative z-10 p-6 sm:p-8 w-full max-w-[340px] flex flex-col items-start">
            <span className="text-[11px] font-bold uppercase tracking-[0.2em] text-[#3b2dd0] mb-4">AFTER</span>
            <ul className="space-y-3">
  ...
  const steps = [
    {
      ...
      illustration: "https://raw.githubusercontent.com/balazser/undraw-svg-collection/refs/heads/main/svgs/education.svg"
    },
    {
      title: "Professional",
      description: "Achieving goals and creating impact.",
      illustration: "https://raw.githubusercontent.com/balazser/undraw-svg-collection/refs/heads/main/svgs/programming.svg"
    },
    {
      title: "Mentor",
      description: "Inspiring and guiding the next generation.",
      illustration: "https://raw.githubusercontent.com/balazser/undraw-svg-collection/refs/heads/main/svgs/collaboration.svg"
    }
  ];
  ...
  return (
    <section className="w-full bg-[#fbfbfb] border-t border-gray-100 px-5 sm:px-6 lg:px-10 xl:px-20 pt-10 sm:pt-12 pb-12 sm:pb-16 flex flex-col lg:flex-row items-center lg:items-start justify-between gap-10 lg:gap-16">
      ...
      <div className="w-full lg:w-[65%] relative flex flex-col md:flex-row items-center md:items-start justify-between gap-12 md:gap-4 mt-6 lg:mt-0">
        ...
        {steps.map((step, idx) => (
          <div key={idx} className="flex flex-col items-center text-center px-2 w-full md:w-1/3 relative z-10">
    ...
    <section className="w-full bg-[#fbfbfb] px-5 sm:px-6 lg:px-10 xl:px-20 pb-20 pt-10">
      <div className="relative w-full max-w-7xl mx-auto rounded-[12px] bg-[#0A102A] overflow-hidden flex flex-col md:flex-row items-center justify-between min-h-[110px] shadow-lg">
        ...
        <div className="hidden md:block absolute inset-y-0 right-0 w-[40%] z-0 opacity-20 pointer-events-none">
          <svg width="100%" height="100%" viewBox="0 0 400 130" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0 130 C 100 80, 200 150, 400 0" fill="none" stroke="rgba(255,255,255,0.2)" strokeWidth="1" strokeDasharray="2 4"/>
            <path d="M0 150 C 150 100, 250 170, 400 20" fill="none" stroke="rgba(255,255,255,0.2)" strokeWidth="1" strokeDasharray="2 4"/>
            <path d="M0 170 C 200 120, 300 190, 400 40" fill="none" stroke="rgba(255,255,255,0.2)" strokeWidth="1" strokeDasharray="2 4"/>
            <path d="M0 190 C 250 140, 350 210, 400 60" fill="none" stroke="rgba(255,255,255,0.2)" strokeWidth="1" strokeDasharray="2 4"/>
            <path d="M0 210 C 300 160, 400 230, 400 80" fill="none" stroke="rgba(255,255,255,0.2)" strokeWidth="1" strokeDasharray="2 4"/>
          </svg>
        </div>
        ...
        <div className="relative z-10 w-full flex flex-col md:flex-row items-center justify-between py-6 px-6 md:py-7 md:px-10 lg:px-12 gap-6 md:gap-4">
          ...
          <div className="w-full md:w-auto flex flex-col items-start text-left md:ml-[15%] lg:ml-[12%]">
            <span className="text-[15px] sm:text-[17px] font-serif text-white/90 mb-0.5 leading-tight">One day...</span>
            <h2 className="text-[20px] sm:text-[23px] lg:text-[26px] font-serif font-normal text-white leading-[1.2]">
              Someone may read your story<br className="hidden md:block" /> the way you just imagined theirs.
            </h2>
          </div>
